...
public class AppDatabaseDef extends DatabaseFactoryImpl {
	...
	public static final String DATABASE_NAME	= "mvnserver";
	...
	public static String[] getInstances() {
		...
		String inst = Platform.getProperty("mvnserver.instances");
	...
	public _Database loadDatabase(String databaseName) throws JsonException {
		...
		_Database db = new _Database(DATABASE_NAME, "mvnserver", DATABASE_VERSION);
